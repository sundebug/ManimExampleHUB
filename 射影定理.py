...
class Rtat(Scene):  # Right triangle altitude theorem
    def construct(self):
        A, B, C, D = np.array(((0, 2, 0), (-4, 0, 0), (1, 0, 0), ORIGIN))
        log.info(A)
        ...
        ag = Succession(
            TransformFromCopy(polyline_BD_DA, rtat_formular[tex_string[0]]),
            TransformFromCopy(polyline_AC_AD, rtat_formular[tex_string[2]]),
        )
        self.play(ag, run_time=10)
...
if __name__ == '__main__':
    ...
    runScene(Rtat, skip_animations=False)
